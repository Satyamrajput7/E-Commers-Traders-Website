        ...
        if ($stmt = $conn->prepare($sql)) {
            ...
            if ($user && password_verify($password, $user['password'])) {
                ...
                if ($_SESSION['user_role'] == 'employer') {
                    ...
                    header("Location: dashboard.php"); // Redirect job seekers to dashboard
                }
                exit();
            } else {
...
<body>
    ...
    <script>
      ...
      // Typewriter Effect
      const quotes = [
  "🌠 Dream Big, Sell Big! Today’s efforts will fuel tomorrow’s profits...🏆",
  "🚧 Failures Fuel Growth! Learn from setbacks and keep scaling your business...💡",
  "🌍 Shape Your eCommerce Empire! Every choice you make builds your future...✨",
  "🔥 Consistency is King! Small daily tweaks to your shop lead to massive wins...🌟"
];
